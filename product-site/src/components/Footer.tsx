...
const Footer: FC = () => {
  ...
  return (
    <footer id="contact" className="scroll-mt-12 border-t border-[#d2d2d7]/50 bg-[#1d1d1f]">
      {/* Contact section */}
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <a
              href={`tel:${t.contact.phone}`}
              onClick={() => trackContactClick("phone")}
              className="mt-5 inline-flex h-9 items-center rounded-full bg-[#0071e3] px-5 text-xs font-medium text-white transition-all hover:bg-[#0077ED]"
            >
              {t.contact.callCta}
            </a>
          </div>
