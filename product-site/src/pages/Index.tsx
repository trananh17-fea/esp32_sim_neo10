          ...
          <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl bg-[#f5f5f7] p-4">
                ...
                <p className="mt-1 text-xs leading-relaxed text-[#86868b]">Liên hệ trực tiếp qua số <span className="font-semibold text-[#8B5E3C]">0775316675</span> hoặc Zalo cùng số này.</p>
              </div>
            </div>
            <a href="tel:0775316675"
              className="mt-6 inline-flex h-11 w-full items-center justify-center rounded-full bg-[#8B5E3C] text-sm font-medium text-white hover:bg-[#6F4A2F]">
              Gọi ngay hỗ trợ
            </a>
          </div>
        </div>
